            ...
            <div className="backdrop-blur-[20px] rounded-3xl bg-gradient-to-b from-white/[0.08] to-white/[0.03] p-8 border border-white/[0.08] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
                ...
                <div className="group">
                  ...
                  <div className="relative flex items-center rounded-2xl border border-white/[0.12] bg-white/[0.04] backdrop-blur-xl px-4 transition-all duration-300 focus-within:border-[#2997ff]/60 focus-within:bg-white/[0.08] focus-within:shadow-[0_0_20px_rgba(41,151,255,0.2),inset_0_1px_0_0_rgba(255,255,255,0.1)] hover:border-white/20 hover:bg-white/[0.06]">
