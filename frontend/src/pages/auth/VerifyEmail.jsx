...
const VerifyEmailPage = () => {
  ...
  const { verifyEmail } = useAuth(); // ⚙️ Hàm này bạn cần định nghĩa trong useAuth()
    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[var(--color-brand-700)] transition-colors px-4">
      <div className="w-full max-w-md card space-y-6">
        ...
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-bold">{t("auth.verifyEmail")}</h2>
        ...
        {!sent ? (
          ...
          <div className="text-center space-y-4">
            ...
            <h3 className="font-semibold">{t("auth.verifyEmailSent")}</h3>
