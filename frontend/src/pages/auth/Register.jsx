              ...
              {step === 1 && (
                <form onSubmit={handleSubmit(onSubmitStep1)} className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative flex items-center rounded-xl bg-white/[0.03] border border-white/[0.06] px-4 transition-all duration-200 focus-within:border-[#0f83f0]/40 focus-within:bg-white/[0.05]">
