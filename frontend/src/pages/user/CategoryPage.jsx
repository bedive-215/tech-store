...
export default function CategoryPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            {/* Hero Banner */}
            <section className={`relative pt-28 pb-16 bg-gradient-to-br ${category.bgGradient} overflow-hidden`}>
                {/* Decorative elements */}
            ...
            <section className="py-8 md:py-12">
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                {activeFiltersCount > 0 && (
                                    <span className="w-5 h-5 bg-[#2997ff] text-white text-xs font-bold rounded-full flex items-center justify-center">
                                        {activeFiltersCount}
                                    </span>
                                )}
                            </button>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 pr-10 text-sm font-medium text-gray-300 cursor-pointer hover:border-white/20 focus:outline-none focus:ring-2 focus:ring-[#2997ff]"
                                >
                                    <option value="" className="bg-black">Mặc định</option>
                                    ...
                                    <option value="newest" className="bg-black">Mới nhất</option>
                                </select>
                    ...
                    {/* Filters Panel */}
                    {showFilters && (
                        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-4 md:p-6 mb-6 md:mb-8" data-aos="fade-down">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                {category.brands?.length > 0 && (
                                    <div>
                                        <h4 className="text-sm font-medium text-gray-300 mb-3">Thương hiệu</h4>
                                ...
                                {/* Price Filter */}
                                <div>
                                    <h4 className="text-sm font-medium text-gray-300 mb-3">Mức giá</h4>
                                    <div className="flex flex-wrap gap-2">
                    ...
                    {error && (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            <div className="w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mb-4">
                                <HiOutlineXMark className="w-8 h-8 text-red-400" />
                            </div>
                            <p className="text-red-400 font-medium mb-2">Đã xảy ra lỗi</p>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-5 lg:gap-6">
                            {products?.length > 0 ? (
                                    ...
                                    return (
                                        ...
                                        >
                                            <button
                                                ...
                                                className="w-full text-left focus:outline-none focus:ring-2 focus:ring-[#2997ff] focus:ring-offset-2 focus:ring-offset-black rounded-2xl"
                                            >
                                ...
                                <div className="col-span-full flex flex-col items-center justify-center py-20">
                                    ...
                                    <p className="text-gray-400 font-medium">Không tìm thấy sản phẩm</p>
                                    <p className="text-gray-500 text-sm mt-1">Thử thay đổi bộ lọc hoặc từ khóa tìm kiếm</p>
                                    {activeFiltersCount > 0 && (
                                        <button
                                            onClick={clearFilters}
                                            className="mt-4 px-4 py-2 bg-[#2997ff] text-white text-sm font-medium rounded-lg hover:bg-[#2997ff]/80 transition-colors"
                                        >
                                            Xóa bộ lọc
                                        </button>
                                    )}
